...
const contents = {
  ...
  sm_desc_1: "Myllash builds digital products that let people do things differently. Share your challenge with our team, and we’ll work with you to deliver a revolutionary digital product. Our clients have changed the way people do banking, listen to music.",
          ...
          <div className="ac-feature-border-top">
            <div className="row">
              <FeatureItem title={'Project kikoff'}
                subtitle={'At myllash we specialize designing building, shipping...'} />
